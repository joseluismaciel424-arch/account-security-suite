...
export const initDatabase = async () => {
  ...
  await pool.query(`CREATE TABLE IF NOT EXISTS users (
    ...
    mfa_enabled BOOLEAN NOT NULL DEFAULT false, mfa_secret_encrypted TEXT, recovery_email TEXT,
    recovery_codes_hashes JSONB NOT NULL DEFAULT '[]'::jsonb, mfa_failed_attempts INTEGER NOT NULL DEFAULT 0,
    mfa_locked_until TIMESTAMPTZ, created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(), updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW()
  )`);
  ...
  await pool.query(`CREATE TABLE IF NOT EXISTS security_events (
    ...
    title TEXT NOT NULL, description TEXT NOT NULL, metadata JSONB NOT NULL DEFAULT '{}'::jsonb,
  ...
  await pool.query(`CREATE TABLE IF NOT EXISTS sessions (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(), user_id UUID NOT NULL REFERENCES users(id) ON DELETE CASCADE,
    token_hash TEXT NOT NULL UNIQUE, device_name TEXT, user_agent TEXT, ip_address INET,
    mfa_verified BOOLEAN NOT NULL DEFAULT false, created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
